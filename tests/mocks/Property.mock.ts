...
export const PropertyMock: IProperty = {
  id: 101,
  img: 'https://images.unsplash.com/photo-1600585154340-0ef3c08c0632?auto=format&fit=crop&w=1200&q=80',
...
export const PropertiesMock: IProperty[] = [
  {
    id: 101,
    img: 'https://plus.unsplash.com/premium_photo-1661950439212-558fa5cc82e0?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=3251',
    name: 'Midtown Skyline Loft',
    description:
      'Contemporary loft with floor-to-ceiling windows, dedicated workspace, and concierge amenities.',
    location: 'Midtown, New York, NY',
